...
namespace GraphQLProject.Data
{
    public class GraphQLDbContext : DbContext
    {
        ...
        //em Generics, invés de ter criado cada 'Menus' para um tipo específico do 'Menu' (entre em definição), ele criou o método genérico 
        //do Menus para ter essa escolha inteligente dos tipos. Junto disso, colocou o get (já que o Id, name, etc etc) tem valor null, o get 
        //pega null e o set pega o valor de acordo com o que o usuário pedir
